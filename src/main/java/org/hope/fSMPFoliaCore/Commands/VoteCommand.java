...
public class VoteCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        sender.sendMessage(Component.text(lang.getVoteHeader(), lang.primary()).decorate(TextDecoration.BOLD));
        if (links.isEmpty()) {
            sender.sendMessage(Component.text(lang.getVoteNoLinks(), lang.secondary()));
            return true;
        }
        for (int i = 0; i < links.size(); i++) {
            ...
            Component btn = Component.text()
                    ...
                    .append(Component.text(lang.getVoteSite(i + 1), lang.primary())
                            .decorate(TextDecoration.UNDERLINED)
                            .clickEvent(ClickEvent.openUrl(link))
                            .hoverEvent(HoverEvent.showText(Component.text(link, lang.secondary()))))
                    .build();
